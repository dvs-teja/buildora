...
function ProjectList() {
  ...
  // When a project card is clicked, show its details modal
  ...
  // When Buy Now clicked, open buy modal and stop event bubbling
  ...
  // WhatsApp URL dynamically includes project title in the message
  const getWhatsappUrl = (project) => {
    if (!project) return '';
    const text = encodeURIComponent(
      `Hi, I am interested in buying your project titled "${project.title}". Please share more details.`
    );
    return `https://wa.me/918885630224?text=${text}`;
  };
  ...
  return (
    <div className="project-list-bg">
      <div
        ...
        style={{ maxWidth: 1200, width: '100%', margin: '0 auto', padding: '24px' }}
      >
        <h2 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: 16, color: '#fff' }}>
          Available Projects
        </h2>
        <div
          style={{
        ...
        <div className="project-modal-overlay" onClick={closeModal}>
          <div className="project-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="project-modal-content">
              ...
              <p>
                <strong>Setup Time:</strong> {selectedProject.setupTime}
              </p>
              <p>
                <strong>What's Included:</strong> {selectedProject.whatIncluded}
              </p>
              <p>
                <strong>Seller Notes:</strong> {selectedProject.sellerNotes}
              </p>
        ...
        <div className="project-modal-overlay" onClick={closeModal}>
          ...
          >
            ...
            <p style={{ marginTop: 10 }}>
              By proceeding to buy this project, you agree that this project is for{' '}
              <strong>educational purposes only.</strong> You will not use this project for any illegal
              or unethical activities.
            </p>
            <p style={{ fontWeight: 600, marginTop: 20 }}>
              Many users have successfully purchased and used this project for their learning and
              development.
            </p>
            <div style={{ marginTop: 30, display: 'flex', justifyContent: 'center' }}>
              <a
                href={getWhatsappUrl(buyProject)}
                target="_blank"
